...
export function GenerateEditPreview(arg1:string,arg2:db.EditSettings,arg3:number):Promise<string>;
...
export function GetEditJobStatus(arg1:string):Promise<db.EditJob>;

export function GetEditOptions():Promise<app.EditOptions>;

export function GetEditVideoMetadata(arg1:string):Promise<editor.VideoMetadata>;
...
export function SubmitEditJob(arg1:string,arg2:string,arg3:db.EditSettings):Promise<string>;
