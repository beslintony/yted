...
describe('versionStore', () => {
  ...
  it('should set loading state during fetch', async () => {
    const mockedGetVersion = GetVersion as unknown as ReturnType<typeof vi.fn>;
    mockedGetVersion.mockImplementation(() => new Promise(resolve => setTimeout(() => resolve('1.0.0'), 10)));
  ...
  it('should not update version if component unmounts during fetch', async () => {
    const mockedGetVersion = GetVersion as unknown as ReturnType<typeof vi.fn>;
    mockedGetVersion.mockImplementation(() => new Promise(resolve => setTimeout(() => resolve('1.0.0'), 100)));
